                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="w-[calc(100%-3.25rem)]">
                        ...
                        <blockquote className="mt-3">
                          <p className="text-gray-700 dark:text-gray-300">
                            Tailus is really extraordinary and very practical,
                            no need to break your head. A real gold mine.
                          </p>
                        </blockquote>
                      </div>
                    </div>
                  ...
                  <div className="p-[--card-padding] rounded-[--card-border-radius] border bg-white border-[--ui-light-border-color] dark:bg-[--card-dark-bg] dark:border-[--ui-dark-border-color] group">
                    <div className="flex gap-3">
                      ...
                      <div className="w-[calc(100%-3.25rem)]">
                        ...
                        <blockquote className="mt-3">
                          <p className="text-gray-700 dark:text-gray-300">
                            I am really new to Tailwind and I want to give a go
                            to make some page on my own. I searched a lot of
                            hero pages and blocks online. However, most of them
                            are not giving me a clear view or needed some
                            HTML/CSS coding background to make some changes from
                            the original or too expensive to have. I downloaded
                            the one of Tailus template which is very clear to
                            understand at the start and you could modify the
                            codes/blocks to fit perfectly on your purpose of the
                            page.
                          </p>
                        </blockquote>
                      </div>
                  ...
                  <div className="p-[--card-padding] rounded-[--card-border-radius] border bg-white border-[--ui-light-border-color] dark:bg-[--card-dark-bg] dark:border-[--ui-dark-border-color] group">
                    <div className="flex gap-3">
                      ...
                      <div className="w-[calc(100%-3.25rem)]">
                        ...
                        <blockquote className="mt-3">
                          <p className="text-gray-700 dark:text-gray-300">
                            Tailus is redefining the standard of web design,
                            with these blocks it provides an easy and efficient
                            way for those who love beauty but may lack the time
                            to implement it. I can only recommend this
                            incredible wonder.
                          </p>
                        </blockquote>
                      </div>
                  ...
                  <div className="p-[--card-padding] rounded-[--card-border-radius] border bg-white border-[--ui-light-border-color] dark:bg-[--card-dark-bg] dark:border-[--ui-dark-border-color] group">
                    <div className="flex gap-3">
                      ...
                      <div className="w-[calc(100%-3.25rem)]">
                        ...
                        <blockquote className="mt-3">
                          <p className="text-gray-700 dark:text-gray-300">
                            Using TailsUI has been like unlocking a secret
                            design superpower. Is the perfect fusion of
                            simplicity and versatility, enabling us to create
                      ...
                      <div className="w-[calc(100%-3.25rem)]">
                        ...
                        <blockquote className="mt-3">
                          <p className="text-gray-700 dark:text-gray-300">
                            ...
                            accelerated my workflow. The flexibility to
                            customize every aspect allows me to create unique
                            user experiences. Tailus is a game-changer for
                      ...
                      <div className="w-[calc(100%-3.25rem)]">
                        ...
                        <blockquote className="mt-3">
                          <p className="text-gray-700 dark:text-gray-300">
                            ...
                            css components it very helpfull to start fast with
                            your project.
                          </p>
                        </blockquote>
                      </div>
                      ...
                      <div className="w-[calc(100%-3.25rem)]">
                        ...
                        <blockquote className="mt-3">
                          <p className="text-gray-700 dark:text-gray-300">
                            ...
                            who wants to create a beautiful and functional
                            website without any web design experience. The
                            templates are easy to use, customizable, and
                            responsive, and the support team is always available
                            to help. I highly recommend Tailus templates to
                  ...
                  <div className="p-[--card-padding] rounded-[--card-border-radius] border bg-white border-[--ui-light-border-color] dark:bg-[--card-dark-bg] dark:border-[--ui-dark-border-color] group">
                    <div className="flex gap-3">
                      ...
                      <div className="w-[calc(100%-3.25rem)]">
                        ...
                        <blockquote className="mt-3">
                          <p className="text-gray-700 dark:text-gray-300">
                            Tailus is so well designed that even with a very
                            poor knowledge of web design you can do miracles.
