            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex-shrink-0">
                <span className="text-xl font-bold leading-none text-gray-900 sm:text-2xl dark:text-white">
                  $45,385
                  <Link href="dashboard/books">Link to books</Link>
                </span>
            ...
            <form className="overflow-y-auto lg:max-h-[60rem] 2xl:max-h-fit">
              <article className="mb-5">
                ...
                <p className="mb-2 text-gray-900 dark:text-white">
                  ...
                  Lets schedule a kick-off meeting and workshop this week. It
              ...
              <article className="mb-5">
                ...
                <p className="mb-2 text-gray-900 dark:text-white">
                  ...
                  cant wait to start working on this new project with you guys.
                  But first things first, Iaam waiting for the offer and pitch
              ...
              <article className="mb-5">
                <footer className="flex items-center justify-between mb-2">
                  <div className="flex items-center">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      <time title="February 8th, 2022">01/03/2023 4:15 PM</time>
                    </p>
                  </div>
                  <button
                ...
                <p className="mb-2 text-gray-900 dark:text-white">
                  ...
                  Iaam attaching our offer and pitch deck. Take your time to
                  review everything. Iaam looking forward to the next steps!
                  Thank you.
                </p>
                <p className="mb-3 text-gray-900 dark:text-white">
                  Looking forward to it! Thanks.
