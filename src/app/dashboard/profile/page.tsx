          ...
          <div className=" sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4">
            ...
            <div>
              ...
              <p className="text-white">
                We use the information from your Google account, however, you
                can update your profile info at any time.
              </p>

              <div className="mt-1">
                <p className="my-2 text-white">Your roles: </p>
                <div className="flex gap-2">
                  {roles.map((role) => (
                    <span
                      key={role}
                      className="bg-gray-300 rounded-full p-2 px-4"
                    >
                      {role.replaceAll("_", " ").split("ROLE")[1].trim()}
                    </span>
                  ))}
                </div>
              </div>
        ...
        <div className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
          <div className="flow-root">
            <h3 className="text-xl font-semibold dark:text-white">
              Social accounts (Reemplazar por lista de dispositivos de login)
            </h3>
            ...
            <div className="grid grid-cols-6 gap-6">
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                <input
                  ...
                  id="address"
                  className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                  placeholder="Add your address, e.g. 1234 Main St, California"
                  required
                />
              </div>
              <div className="col-span-6 sm:col-span-3">
              ...
              <div className="col-span-12 sm:col-span-6">
                ...
                <textarea
                  name="description"
                  id="description"
                  className="shadow-sm h-32 min-h-24 max-h-40 bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
              ...
              <div className="col-span-6 sm:col-full">
                <button
                  className="text-white bg-blue-800 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                  type="submit"
                >
                  Save all
                </button>
