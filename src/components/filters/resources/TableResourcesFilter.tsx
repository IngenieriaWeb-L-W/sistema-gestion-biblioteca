            ...
            <form className="lg:pr-3 w-full">
              <div className="relative flex gap-3 mt-1">
                <input
                  ...
                  placeholder="Search by title, author, short description or ISBN"
                />
                ...
                >
                  {Object.keys(ResourceTypes).map((status) => (
...
export default TableResourcesFilter;
