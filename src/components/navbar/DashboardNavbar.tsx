...
export const DashboardNavbar = () => {
  return (
    <React.Fragment>
      <nav className="fixed z-30 w-full  border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <div className="px-3 py-4 bg-red lg:px-5 lg:pl-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              ...
              <div
                className="z-20 hidden max-w-sm my-4 overflow-hidden text-base list-none divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700"
              ...
              <div
                className="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none  divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600"
                id="apps-dropdown"
              >
                <div className="block px-4 py-2 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                  Apps
